...
//create a class onlinetest and extend by jframe now implement actionlistener to handle action
public class onlinetest extends JFrame implements ActionListener {
    private static final long serialVersionUID = 1L;
    //here created a jlabel,jradiobutton on jframe
    JLabel label;
    ...
    //here write a code .display ques with option in jframe
    void set() {
    ...
    public static void main(String[] args) {
        //now call constructor and initialize jframe
